Public Class PingDashboardForm
    ...
    Private Sub InternetOptionsLinkLabel_LinkClicked(sender As Object, e As LinkLabelLinkClickedEventArgs) Handles InternetOptionsLinkLabel.LinkClicked
        'Opens the Internet Options Control Panel applett
        Process.Start("rundll32.exe", "shell32.dll,Control_RunDLL inetcpl.cpl,,1")
    End Sub

    Private Sub NetworkInterfacesLinkLabel_LinkClicked(sender As Object, e As LinkLabelLinkClickedEventArgs) Handles NetworkInterfacesLinkLabel.LinkClicked
        'Opens the Network Interfaces Control Panel applett
    ...
    Private Sub WindowsFirewallLinkLabel_LinkClicked(sender As Object, e As LinkLabelLinkClickedEventArgs) Handles WindowsFirewallLinkLabel.LinkClicked
        'Opens the Windows Firewall Control Panel applett
        Process.Start("RunDll32.exe", "shell32.dll,Control_RunDLL firewall.cpl")
    End Sub

    Private Sub IPsettingsButton_Click(sender As Object, e As EventArgs) Handles IPsettingsButton.Click
        IPwindow.Show()
    End Sub
